...
// End Cross Module References
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_monoMesh_MetaData[];
#endif
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp_monoMesh;
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AMono_Statics::NewProp_Instancia_MetaData[] = {
		{ "ModuleRelativePath", "Mono.h" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AMono_Statics::NewProp_Instancia = { "Instancia", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AMono, Instancia), Z_Construct_UClass_AMono_NoRegister, METADATA_PARAMS(Z_Construct_UClass_AMono_Statics::NewProp_Instancia_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AMono_Statics::NewProp_Instancia_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FClassPropertyParams Z_Construct_UClass_AMono_Statics::NewProp_ProjectileClass = { "ProjectileClass", nullptr, (EPropertyFlags)0x0024080000010001, UE4CodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AMono, ProjectileClass), Z_Construct_UClass_ABarril_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(Z_Construct_UClass_AMono_Statics::NewProp_ProjectileClass_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AMono_Statics::NewProp_ProjectileClass_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AMono_Statics::NewProp_monoMesh_MetaData[] = {
		{ "Category", "Mono" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Mono.h" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AMono_Statics::NewProp_monoMesh = { "monoMesh", nullptr, (EPropertyFlags)0x00200800000a0009, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AMono, monoMesh), Z_Construct_UClass_UStaticMeshComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_AMono_Statics::NewProp_monoMesh_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AMono_Statics::NewProp_monoMesh_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AMono_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AMono_Statics::NewProp_Instancia,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AMono_Statics::NewProp_ProjectileClass,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AMono_Statics::NewProp_monoMesh,
	};
	...
	IMPLEMENT_CLASS(AMono, 2017174573);
