...
// End Cross Module References
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AEnemigoDragon_Statics::PropPointers[] = {
		...
		const UE4CodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_AEnemigoDragon_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UISuscriptor_NoRegister, (int32)VTABLE_OFFSET(AEnemigoDragon, IISuscriptor), false },
			{ Z_Construct_UClass_UITransfromar_NoRegister, (int32)VTABLE_OFFSET(AEnemigoDragon, IITransfromar), false },
		};
	...
	IMPLEMENT_CLASS(AEnemigoDragon, 557448320);
